...
-- Completes lifecycle states, server-side validation and authoritative field
-- protection without deleting legacy pricing or quotation records.
...
AS $$
DECLARE
  v_privileged boolean := current_user IN (
