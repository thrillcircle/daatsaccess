-- Phase 7 PayFast reconciliation convergence.
--
-- Lovable's synchronised migration may have installed an earlier definition of
-- process_payfast_itn. Re-apply the canonical guarded definition so a late
-- COMPLETE ITN can never revive a superseded, failed, cancelled or refunded
-- payment intent. This migration is safe whether the canonical definition is
-- already live or not.
