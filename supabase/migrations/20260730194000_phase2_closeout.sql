-- Phase 2 closeout corrections.
-- Support writes must use the protected RPCs, and administrator-originated
-- passenger/driver cases notify the affected participant.
