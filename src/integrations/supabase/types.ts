...
export type Database = {
  ...
  public: {
    ...
    Enums: {
      ...
      fleet_operational_status: "active" | "maintenance" | "out_of_service" | "retired";
      itinerary_item_type:
        "ride" | "waiting" | "appointment" | "accommodation" | "activity" | "other";
      journey_pattern: "one_way" | "return" | "wait_and_return" | "recurring" | "multi_day";
      ...
      ride_status:
        ...
        | "completed"
        | "cancelled";
      service_type: "transport" | "assisted" | "appointment" | "extended_journey";
    };
    CompositeTypes: {
      [_ in never]: never;
    };
...
export const Constants = {
  public: {
    Enums: {
      ...
      deposit_status: ["none", "pending", "paid", "refunded", "waived"],
      fleet_operational_status: ["active", "maintenance", "out_of_service", "retired"],
      itinerary_item_type: ["ride", "waiting", "appointment", "accommodation", "activity", "other"],
      journey_pattern: ["one_way", "return", "wait_and_return", "recurring", "multi_day"],
      payment_status: ["pending", "paid", "failed", "refunded"],
      quote_status: [
        "draft",
